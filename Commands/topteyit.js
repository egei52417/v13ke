...
module.exports.beta = async(client, message, args) => {    
    ...
    message.channel.send({ embeds: [new MessageEmbed().setAuthor({name:`Top Teyit Listesi`, iconURL: message.guild.iconURL({dynamic: true})).setTimestamp().setColor("BLACK").setDescription(top)] } });
};
